  ...
  return (
    <div className="grid grid-cols-12 gap-6">
      ...
      >
        ...
        <h6 className="text-base text-primary">کل تیکت‌ها</h6>
      </div>
      ...
      >
        ...
        <h6 className="text-base text-warning">تیکت‌های در انتظار</h6>
      </div>
      ...
      >
        ...
        <h6 className="text-base text-success">تیکت‌های باز</h6>
      </div>
      ...
      >
        ...
        <h6 className="text-base text-error">تیکت‌های بسته</h6>
      </div>
    </div>
  );
};
